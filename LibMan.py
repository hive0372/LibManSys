...
ui, _ = loadUiType('Data/Library.ui')
login, _ = loadUiType('Data/LogWindow.ui')
...
class Login(QWidget, login):
    def __init__(self):
        ...
        style = open('Data/Themes/Black.css', 'r')
        style = style.read()
...
####### ** ---------------- ** #######
    ...
    def BreezeDrk_theme(self):
        style = open('Data/Themes/Breeze_dark_style.css', 'r')
        style = style.read()
        self.setStyleSheet(style)

    def DrkOrange_theme(self):
        style = open('Data/Themes/DrkOrange.css', 'r')
        style = style.read()
        self.setStyleSheet(style)

    def Navy_theme(self):
        style = open('Data/Themes/Navy.css', 'r')
        style = style.read()
        self.setStyleSheet(style)
